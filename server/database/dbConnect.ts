...
export async function getValue(sql: string, params?: any[], columnName?: string) {
	/**
	 * Get a specific value from the database. This will return the first row and, if columnName is 
	 * provided, the value of that column, otherwise the first value in the row. 
	 * 
	 * @param {string} sql - The SQL query to run
	 * @param {any[]} params - The parameters to pass to the query [optional]
...
export async function runUpdate(sql: string, params?: any[]) {
	/**
	 * Run an update query on the database. This will return the number of rows affected.
	 * 
	 * @param {string} sql - The SQL query to run
	 * @param {any[]} params - The parameters to pass to the query [optional]
	 * 
